...
use App\Http\Resources\Rent\PaymentCollection;
...
class PaymentController extends Controller
{
    ...
    public function get(Request $request)
    {
        ...
        if ($request->filled(['per_page', 'page'])) {
            ...
            $resource = new PaymentCollection($result);
            $response['data'] = [
                'data' => $resource,
                'total' => $result->total(),
    ...
    {
        $validator = Validator::make($request->all(), [
            'id' => 'required|string|exists:rent_payment,id',
        ]);
    ...
    public function export(Request $request)
    {
        ...
        $headers = [
            __('User'),
            __('rent.amount'),
            __('rent.payment.month'),
            __('rent.payment.date'),
            __('Remark'),
            __('Created at'),
            __('Updated at'),
        ];
        ...
        $path = MyPhpOffice::exportTableWithPath('rent-payment', $rows, $headers, 'pdf');
