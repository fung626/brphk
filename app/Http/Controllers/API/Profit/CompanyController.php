...
use App\Http\Resources\Profit\CompanyCollection;
...
class CompanyController extends Controller
{
    ...
    public function details(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'id' => 'required|string|exists:profit_company,id',
        ]);
        ...
        $result = Company::with(['user'])->where(['id' => request('id')])->first();
        $response = config('response.common.success');
    ...
    public function update(Request $request)
    {
        ...
        $response = config('response.common.success');
        $response['data'] = Company::where(['id' => request('id')])->first();
        return response()->json($response, 200);
    }
    ...
    public function export(Request $request)
    {
        ...
        $path = MyPhpOffice::exportTableWithPath('profit-company', $rows, $headers, 'pdf');
    ...
    {
        $validator = Validator::make($request->all(), [
            'id' => 'required|string|exists:profit_comapny,id',
        ]);
