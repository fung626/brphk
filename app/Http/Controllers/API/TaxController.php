...
class TaxController extends Controller
{
    ...
    public function get(Request $request)
    {
        ...
        $query = Tax::with(['users'])
            ...
            ->leftJoin('users', 'users.id', '=', 'tax.user_id')
            ->groupBy('tax.id');
        ...
        if ($request->filled(['per_page', 'page'])) {
            $result = $query->paginate(request('per_page'), ['*'], 'page', request('page'));
            $resource = new TaxCollection($result);
            $response['data'] = [
                'data' => $resource,
                'total' => $result->total(),
    ...
    public function details(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'id' => 'required|string|exists:tax,id',
        ]);
    ...
    public function export(Request $request)
    {
        ...
        $path = MyPhpOffice::exportTableWithPath('tax', $rows, $headers, 'pdf');
