...
export default {
        ...
        return new Promise((resolve, reject) => {
            axios
                ...
                .then(function(response) {
                    ...
                    commit(types.FETCH_DEBTS_SUCCESS, res);
                    resolve(res);
                })
    ...
    [`${name}/events`]({ commit, dispatch }, payload) {
        return new Promise((resolve, reject) => {
            axios
                .post(`${endpoint}events`, payload)
                .then(function(response) {
                    // let data = response.data.data;
                    // response.data.data.forEach(function(item, index) {
                    //     response.data.data[index].start = new Date(item.start);
                    //     response.data.data[index].end = new Date(item.end);
                    // });
        ...
        return new Promise((resolve, reject) => {
            axios({
                ...
                .then(response => {
                    ...
                    fileLink.setAttribute("download", `debt-${datetime}.pdf`);
